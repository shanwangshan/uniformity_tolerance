...
def main(args):
    ...
    if args['learn']['network'] == 'res18':
        ...
        #model.load_state_dict(torch.load("pth/baseline.pth"))
        model_dir ='../self_supervised_tem/self_supervised_0.4/results_models/models_res18_my_experiment_name_unsup_SI271828/'
